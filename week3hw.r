library(sf)
library(here)
data <- st_read("/Users/lu_nanxi/CASA/GIS/Week3/homework_3")
st_layers(here("/Users/lu_nanxi/CASA/GIS/Week3/homework_3", "gadm41_ESP.gpkg"))
library(janitor)
library(tidyverse)
library(terra)
library(ggplot2)

spain <- sf::st_read(here("/Users/lu_nanxi/CASA/GIS/Week3/homework_3", "gadm41_ESP.gpkg"),
                     layer='ADM_ADM_0')
here::here("homework_3", "gadm41_ESP.gpkg")

world_cities <- sf::st_read(here("/Users/lu_nanxi/CASA/GIS/Week3/homework_3", "World_Cities.shp"))
#install libraries
library(terra)
library(here)

ssp1 <- terra::rast(here("/Users/lu_nanxi/CASA/GIS/Week3/homework_3", 
                         "wc2.1_2.5m_tmin_ACCESS-CM2_ssp126_2081-2100.tif"))

ssp1_mean <- mean(ssp1)

ssp5 <- terra::rast(here("/Users/lu_nanxi/CASA/GIS/Week3/homework_3", 
                         "wc2.1_2.5m_tmin_ACCESS-CM2_ssp585_2081-2100.tif"))

#filter cities-ambiguous definition-apply dplyr
...
#violin box
ssp1 <-terra::rast(here("/Users/lu_nanxi/CASA/GIS/Week3/homework_3", "wc2.1_2.5m_tmin_ACCESS-CM2_ssp126_2081-2100.tif"))
ssp2 <-terra::rast(here("/Users/lu_nanxi/CASA/GIS/Week3/homework_3", "wc2.1_2.5m_tmin_ACCESS-CM2_ssp245_2081-2100.tif"))
ssp3 <-terra::rast(here("/Users/lu_nanxi/CASA/GIS/Week3/homework_3", "wc2.1_2.5m_tmin_ACCESS-CM2_ssp370_2081-2100.tif"))
ssp5 <-terra::rast(here("/Users/lu_nanxi/CASA/GIS/Week3/homework_3", "wc2.1_2.5m_tmin_ACCESS-CM2_ssp585_2081-2100.tif"))
